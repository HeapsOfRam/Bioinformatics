...
file_lista = ['input_ch3_1a.txt', 'input_ch3_2a.txt', 'test1_a.txt', 'test2_a.txt', 'test3_a.txt']
file_listb = ['input_ch3_1b.txt', 'input_ch3_2b.txt', 'test1_b.txt', 'test2_b.txt', 'test3_b.txt']
